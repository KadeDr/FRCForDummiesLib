package com.frcfordummies.rev.utils;

import com.studica.frc.AHRS;

import edu.wpi.first.math.geometry.Rotation2d;

public final class NavXGyro extends AHRS {
    private static volatile NavXGyro instance;

    // Checks if the singleton exists, if it doesn't it creates one, else, it uses the already existing one
    public static final synchronized NavXGyro getInstance() {
        return instance == null ? instance = new NavXGyro() : instance;
    }
